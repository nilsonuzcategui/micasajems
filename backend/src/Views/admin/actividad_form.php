    ...
    <form method="POST" action="<?= htmlspecialchars(\App\View::adminUrl('actividades/guardar')) ?>" class="bg-[#101829] border border-white/10 rounded-2xl p-6 space-y-5">
        ...
        <div class="flex items-center justify-between gap-3 pt-4 flex-wrap">
            <label class="inline-flex items-center gap-2 text-sm text-slate-300 cursor-pointer select-none">
                <input type="checkbox" name="notificar_push" value="1" class="accent-[#D4AF37] w-4 h-4" />
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#D4AF37]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
